...
// Local confirmation surface that forces every caller-provided string to plain
// text. QML Text.AutoText can otherwise interpret clipboard or reminder labels
// as rich text and fetch attacker-selected resources.
Item {
  id: root
